...
class HelloComponent4 extends JComponent
    ...
    synchronized private void changeColor() {//synchronized потому что при выполнение 2-ух потоков может быть инкремент в проверки и указанно значение за концом массива
